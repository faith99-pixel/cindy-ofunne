...
const projects: Project[] = [
  {
    id: 1,
    title: "Portfolio Plus Infrastructure Upgrade, GRC, Salesforce & Digital Transformation",
    ...
    fullDescription:
      "Infrastructure Ontario faced critical obstacles modernizing its project portfolio management across multiple departments while supporting C-Suite leadership. The organization struggled with siloed systems preventing enterprise visibility, inconsistent risk management practices, limited business analytics capabilities, and workflow inefficiencies preventing strategic decision-making. Without integrated digital transformation solutions, stakeholders lacked unified frameworks and senior executives had insufficient insights for strategic planning.",
    requirements: [
      "Deploy Portfolio Plus infrastructure upgrade with zero critical incidents",
      "Implement enterprise-wide GRC tool for risk compliance and visibility",
      "Deploy Salesforce CRM for unified customer and stakeholder management",
      "Implement Microsoft Places for workspace optimization",
      "Execute Citrix Upgrade for secure remote access",
      "Integrate ServiceNow for unified workflow and incident management",
      "Provide executive oversight supporting C-Suite and senior leadership",
      "Establish business analytics and workforce planning capabilities",
      "Coach and develop team of 6 project managers",
    ],
    challenges: [
      "Coordinating simultaneous deployment of 6 major enterprise platforms",
      "Integrating diverse systems while maintaining operational continuity",
      "Managing complex stakeholder alignment across executive and operational levels",
      "Providing strategic insights through new analytics capabilities",
      "Building team capacity for advanced digital transformation methodologies",
    ],
    approach:
      "Executive-level strategic oversight combined with phased implementation. Integrated governance framework supporting C-Suite decision-making. Agile execution with continuous business analytics and financial forecasting. Emphasis on change management and stakeholder communication at all levels.",
    solution: [
      "Deployed Portfolio Plus infrastructure upgrade with seamless integration",
      "Implemented GRC tool with automated compliance monitoring and risk remediation",
      "Integrated Salesforce CRM for unified stakeholder management",
      "Deployed Microsoft Places for intelligent workspace utilization",
      "Executed Citrix Upgrade for enhanced secure connectivity",
      "Integrated ServiceNow for unified workflow and incident management",
      "Established business analytics and predictive forecasting capabilities",
      "Implemented high-performance communication framework fostering collaboration",
      "Conducted weekly coaching and lunch-and-learn sessions for continuous development",
      "Designed standardized processes and documentation across all systems",
    ],
    impact: [
      "Enhanced QA process by 15%",
      "Improved overall testing practices by 20%",
      "Coached team of 6 project managers to advanced competency levels",
      "Established C-Suite executive support and strategic direction",
      "Implemented predictive analytics and financial forecasting",
      "Eliminated waste and improved operational efficiencies",
    ],
    methodologies: ["Strategic Planning", "Agile", "Risk Management", "Leadership", "Change Management", "Business Analytics"],
    results: [
      "Platform Integration: 6 major systems deployed seamlessly",
      "System Performance: Enhanced QA by 15% and testing practices by 20%",
      "Team Development: 6 project managers coached to senior competency levels",
      "Executive Alignment: Provided strategic direction to C-Suite and senior leadership",
      "Process Excellence: Standardized processes across all operations with zero critical incidents",
    ],
  },
  {
    id: 2,
