...
export default function Home() {
    return (
        <main className="pt-16 relative" style={{
                        ...
                        <div className="text-center animate-fade-in-up">
                            ...
                            <div className="flex flex-col sm:flex-row justify-center gap-3 sm:gap-4">
                                ...
                                <a
                                    ...
                                    className="px-6 sm:px-10 py-3 sm:py-4 border-2 border-primary text-primary hover:bg-white hover:border-2 hover:border-white/50 hover:text-secondary rounded-2xl transition-all duration-300 font-semibold hover:scale-105 text-sm sm:text-base whitespace-nowrap"
                                >
                                    Get in Touch
                                </a>
                            </div>
                    ...
                    <div className="max-w-6xl mx-auto">
                        ...
                        >
                            {[
                                ...
                                >
                                    <div className="group relative p-8 backdrop-blur-md bg-white/40 border border-white/40 rounded-2xl hover:bg-white/60 hover:border-primary/50 transition-all duration-300 hover:shadow-xl hover:scale-105"
                                    >
            ...
            <motion.section
                className="py-20 px-4 sm:px-6 lg:px-8 bg-secondary text-white"
                initial={{ opacity: 0 }}
                whileInView={{ opacity: 1 }}
                viewport={{ once: true }}
                transition={{ duration: 0.8 }}
            >
                <div className="max-w-6xl mx-auto">
                    ...
                    >
                        ...
                        >
                            <div className="group p-8 backdrop-blur-md bg-white/15 border border-white/30 rounded-2xl hover:bg-white/25 hover:border-primary transition-all duration-300 hover:shadow-lg hover:shadow-primary/20 hover:scale-105">
